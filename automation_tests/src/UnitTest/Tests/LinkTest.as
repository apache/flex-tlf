...
package UnitTest.Tests
{
    ...
    public class LinkTest extends VellumTestCase
    {
        ...
        public function nestedLinkMergeTest():void
        {
            ...
            assertTrue("Link elements were not merged.", (linkEl === linkEl2));
        }
        ...
        [Test(dataProvider=directionDp)]
        public function launchLinkTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function linkEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanMouseDownEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanMouseClickEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanMouseMoveEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanMouseUpEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanRollOverEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanRollOutEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        [Test(dataProvider=directionDp)]
        public function spanMouseEventMirrorTest(direction:String):void
        {
            containerType = "custom";
            setUpTest();
        ...
        private function traceEvent(e:FlowElementMouseEvent):void
        {
