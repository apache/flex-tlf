...
package UnitTest.Tests
{
	...
	public class ListTest extends VellumTestCase
	{
		...
		public static function suite(testConfig:TestConfig, ts:TestSuiteExtended):void
		{
			...
			ts.addTestDescriptor (new TestDescriptor (ListTest, "deleteInList", testConfig ) );
			ts.addTestDescriptor (new TestDescriptor (ListTest, "backspaceMergeEmptyListAndPara", testConfig ) );
		...
		public function deleteInList():void
		{
			...
			var tf:TextFlow = SelManager.textFlow;
			tf.removeChildAt(0);
			var list1:ListElement = new ListElement();
			var list2:ListElement = new ListElement();
			var list3:ListElement = new ListElement();
			var li1:ListItemElement = new ListItemElement();
			var li2:ListItemElement = new ListItemElement();
			var li3:ListItemElement = new ListItemElement();
			...
			span1.text = "a";
			var span11:SpanElement = new SpanElement();
			span11.text = "b";
			span11.fontSize = 20;
			...
			li3.addChild(p3);
			p3.addChild(span3);
			list2.listStyleType = "decimal";
			list3.listStyleType = "disc";		
	
			tf.flowComposer.updateAllControllers();
			SelManager.selectRange(3,3);
			var kDelete:KeyboardEvent = new KeyboardEvent(KeyboardEvent.KEY_DOWN, true, false, Keyboard.DELETE, Keyboard.DELETE);
			TestFrame.container["dispatchEvent"](kDelete);
			SelManager.flushPendingOperations();			
			tf.flowComposer.updateAllControllers();
			var res:String = TextConverter.export(tf,TextConverter.TEXT_LAYOUT_FORMAT, ConversionType.STRING_TYPE) as String;
			assertTrue("Delete key should delete a bullet level",  SelManager.activePosition == 3 && SelManager.anchorPosition == 3 &&
				res == '<TextFlow blockProgression="' + tf.blockProgression + '" direction="' + tf.direction + '" fontFamily="Times New Roman" fontSize="14" paddingLeft="4" ' +
					'paddingTop="4" textIndent="15" whiteSpaceCollapse="preserve" version="3.0.0" xmlns="http://ns.adobe.com/textLayout/2008">' +
					'<list><li><p><span>a</span><span fontSize="20">b</span></p><list listStyleType="disc"><li><p><span></span></p></li></list></li></list><p><span></span></p></TextFlow>');
			SelManager.undo();
			res = TextConverter.export(tf,TextConverter.TEXT_LAYOUT_FORMAT, ConversionType.STRING_TYPE) as String;
			assertTrue("Delete key should delete a bullet level",  SelManager.activePosition == 3 && SelManager.anchorPosition == 3 &&
				res == '<TextFlow blockProgression="' + tf.blockProgression + '" direction="' + tf.direction + '" fontFamily="Times New Roman" fontSize="14" paddingLeft="4" ' +
				'paddingTop="4" textIndent="15" whiteSpaceCollapse="preserve" version="3.0.0" xmlns="http://ns.adobe.com/textLayout/2008">' +
				'<list><li><p><span>a</span><span fontSize="20">b</span></p><list listStyleType="decimal"><li><p><span></span></p><list listStyleType="disc"><li><p><span></span></p></li></list></li></list></li></list></TextFlow>');
		}
		...
		public function backspaceMergeEmptyListAndPara():void
		{
			SelManager.selectAll();
			SelManager.deleteText();
			SelManager.selectRange(0,0);
			...
			tf.flowComposer.updateAllControllers();
			SelManager.selectRange(3,3);
			var kBackSpace:KeyboardEvent = new KeyboardEvent(KeyboardEvent.KEY_DOWN, true, false, Keyboard.BACKSPACE, Keyboard.BACKSPACE);
			TestFrame.container["dispatchEvent"](kBackSpace);
			SelManager.flushPendingOperations();			
			tf.flowComposer.updateAllControllers();
			var res:String = TextConverter.export(tf,TextConverter.TEXT_LAYOUT_FORMAT, ConversionType.STRING_TYPE) as String;
			assertTrue("Delete key should delete a bullet level",  SelManager.activePosition == 2 && SelManager.anchorPosition == 2 &&
				res == '<TextFlow blockProgression="' + tf.blockProgression + '" direction="' + tf.direction + '" fontFamily="Times New Roman" fontSize="14" paddingLeft="4" ' +
				'paddingTop="4" textIndent="15" whiteSpaceCollapse="preserve" version="3.0.0" xmlns="http://ns.adobe.com/textLayout/2008">' +
				'<list><li><p><span>a</span></p><list listStyleType="decimal"><li><p><span fontSize="30">ccccc</span></p></li></list></li></list></TextFlow>');
			SelManager.undo();
			res = TextConverter.export(tf,TextConverter.TEXT_LAYOUT_FORMAT, ConversionType.STRING_TYPE) as String;
			assertTrue("Delete key should delete a bullet level",  SelManager.activePosition == 3 && SelManager.anchorPosition == 3 &&
				res == '<TextFlow blockProgression="' + tf.blockProgression + '" direction="' + tf.direction + '" fontFamily="Times New Roman" fontSize="14" paddingLeft="4" ' +
				'paddingTop="4" textIndent="15" whiteSpaceCollapse="preserve" version="3.0.0" xmlns="http://ns.adobe.com/textLayout/2008">' +
				'<list><li><p><span>a</span></p><list listStyleType="decimal"><li><p><span fontSize="20"></span></p></li></list></li></list><p><span fontSize="30">ccccc</span></p></TextFlow>');
		}
	}
}