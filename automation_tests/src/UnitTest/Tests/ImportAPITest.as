...
package UnitTest.Tests
{
    ...
    public class ImportAPITest extends VellumTestCase
    {
        ...
        private static const htmlTest1:XML = <HTML>
            <BODY>
                <P ALIGN="left">
        ...
        private static const htmlTest2:XML = <HTML>
            <BODY>
                <P ALIGN="left">
                    <FONT FACE="Arial" SIZE="12" COLOR="#AA0000" LETTERSPACING="0" KERNING="1">
                        <b>
        ...
        private static const htmlTest3:XML = <p>
            <font>
                <b/>
            </font>
        </p>;

        private static const htmlTest4a:XML = <p>
            <b/>
        </p>;
        private static const htmlTest4b:XML = <p>Some Text</p>;

        // as XML all the leading/trailing whitespace gets stripped.  Next two should produce indentical results
        private static const htmlTest5a:String = '<p><textformat leading="200%"><i><b>BoldItalic</b></i> </textformat>Plain <i>Italic</i> Plain <b>Bold</b></p>';
        private static const htmlTest5b:String = '<textformat leading="200%"><i><b>BoldItalic</b></i> </textformat>Plain <i>Italic</i> Plain <b>Bold</b>';

        // strikeThrough test
        private static const htmlTest6:String = '<p><s><i><b>StrikeThroughBoldItalic</b></i></b></s></p>';

        // naked listitem test
        private static const htmlTest7:String = '<li>abcd</li>';

        // tests that the group created by the parent of the tested span has the correct typename
        private static const htmlTest8:String = '<P ALIGN="left"><span class="xyz"><FONT FACE="Arial" SIZE="12" COLOR="#000000" LETTERSPACING="0" KERNING="1"><B>Hello</B> <I>World</I></FONT><span></P>';

        private static const htmlCIDTest1:String = '<span id="x1">abcd</span>';
        private static const htmlCIDTest2:String = '<span id="x1"><span>abcd</span><b>XYZ</b></span>';
        private static const htmlCIDTest3:String = '<span><span>abcd</span><b>XYZ</b></span>';

        private static const htmlCIDTest4:String = '<i><span id="x1"><span>abcd</span><b>XYZ</b></span></i>';
        private static const htmlCIDTest5:String = '<i><span><span>abcd</span><b>XYZ</b></span></i>';

        private static const htmlCIDTest6:String = '<span class="x1"><span>abcd</span><b>XYZ</b></span>';
        private static const htmlCIDTest7:String = '<span><span>abcd</span><b>XYZ</b></span>';

        private static const htmlCIDTest8:String = '<i><span class="x1"><span>abcd</span><b>XYZ</b></span></i>';
        private static const htmlCIDTest9:String = '<i><span><span>abcd</span><b>XYZ</b></span></i>';

        private static const htmlCIDTest10:String = '<ul id="ulid"><li id="liid"><p id="pid">noid<span id="spanid">spanid</span><img id="imgid"/></p></li></ul><ol id="olid">olid</ol>';
        private static const htmlCIDTest11:String = '<ul class="ulid"><li class="liclass"><p class="pclass">noclass<span class="spanclass">spanclass</span><img class="imgclass"/></p></li></ul><ol class="olclass">olclass</ol>';

        private static const customTag1:String = '<foo>ABCD</foo>';
        private static const customTag2:String = '<p><foo><a>ABCD</a></foo></p>';
        private static const customTag3:String = '<p><foo><span>ABCD</span><i> ITALIC</i></foo></p>';
        private static const customTag4:String = '<foo><div id="a">text</div></foo>';
        private static const customTag5:String = '<foo><div>text</div></foo>';
        private static const customTag6:String = '<foo><div>text</div><div>text</div></foo>';
        private static const customTag7:String = '<foo><bar>ABCD</bar></foo>';

        public function ImportAPITest()
        {
            TestConfig.getInstance().containerType = "custom";
            super("", "ImportAPITest", TestConfig.getInstance());
        ...
        public function imgSourceFilterFunction():void
        {
            ...
            (textImporter as ITextLayoutImporter).imageSourceResolveFunction = function (source:String):String
            {
            ...
            (textImporter as IHTMLImporter).imageSourceResolveFunction = function (source:String):String
            {
                replacedSource += source;
                return replacedSource;
            };
