...
package UnitTest.Tests
{
    ...
    public class BoxTest extends VellumTestCase
    {
        ...
        {
            super("", "BoxTest2", TestConfig.getInstance());
            metaData = {};
        ...
        {
            _textFlow = SelManager.textFlow;
            var valuesBeforeAndAfter:Array = [
                [-5, 0],
                [0, -5],
                [0, 20],
                [20, 0]
        ...
        {
            _textFlow = SelManager.textFlow;
            var marginAndPaddingLeft:Array = [
                [-20, -20] ,
                [20, 20]
            ];		// start & end padding value pairs
            var startIndex:int = -1;
