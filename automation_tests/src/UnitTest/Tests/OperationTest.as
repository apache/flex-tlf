...
package UnitTest.Tests
{
    ...
    public class OperationTest extends VellumTestCase
    {
        ...
        {
            FileRepository.readFile(TestConfig.getInstance().baseURL, "../../test/testFiles/markup/tlf/severalPages.xml");
        }

        [Before]
        public override function setUpTest():void
        {
            setUpFlowForTest(TextConverter.importToFlow(testFlow, TextConverter.PLAIN_TEXT_FORMAT));
        }
        ...
        private function deleteNextWordFromRange(anchorPosition:int, activePosition:int):void
        {
            var flowLength:int = SelManager.textFlow.textLength;
        ...
        private function deletePreviousWordFromCaret(initialSelection:int):void
        {
            var flowLength:int = SelManager.textFlow.textLength;
        ...
        private function deletePreviousWordFromRange(anchorPosition:int, activePosition:int):void
        {
            var flowLength:int = SelManager.textFlow.textLength;
        ...
        private function limitPasteTest(callback:Object = null):void
        {
            const pastePosition:int = 10;
        ...
        private function deleteNextCharExceptionTest(callback:Object = null):void
        {
        ...
        private function cancelSplitParagraphTest(callback:Object = null):void
        {
            if (!callback)
            {
                callback = true;
        ...
        private function cancelCopyOperationTest(callback:Object = null):void
        {
        ...
        private function mergeEventMirrorTest(e:Event = null):void
        {
            if (e != null)
                return;
        ...
        private function catchEvent(e:Event):void
        {
            ...
            if (e is FlowOperationEvent)
            {
                ...
                var className:String = getQualifiedClassName(FlowOperationEvent(e).operation);
        ...
        private function delayUpdateNoFlowComposer(callBack:Object = null, passThroughData:Object = null):void // 2785924
        {
            if (!callBack)
            {
                // test for 2785924
        ...
        private function operationTestTimeout(passThroughData:Object):void
        {
